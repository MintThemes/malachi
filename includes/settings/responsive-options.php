 ...
 * Step 2. Do a find-and-replace for the term 'mt_malachi_responsive_settings' and replace it with the slug you desire for this page
...
function mt_malachi_responsive_settings(){
	 ...
	 *
	 */
	$args = array('title' => __('Responsive Options', 'mp_core'), 'slug' => 'mt_malachi_responsive_settings', 'type' => 'theme');
	
	//Initialize settings class
	global $mt_malachi_responsive_settings;
	$mt_malachi_responsive_settings = new MP_CORE_Settings($args);
	
	//Include other option tabs
	include_once( 'settings-tab-general.php' );
	
}
add_action('after_setup_theme', 'mt_malachi_responsive_settings');