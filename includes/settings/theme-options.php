 ...
 * Step 2. Do a find-and-replace for the term 'mt_malachi_settings' and replace it with the slug you desire for this page
...
function mt_malachi_settings(){
	 ...
	 *
	 */
	$args = array('title' => __('Theme Options', 'mp_core'), 'slug' => 'mt_malachi_settings', 'type' => 'theme');
	
	//Initialize settings class
	global $mt_malachi_settings;
	$mt_malachi_settings = new MP_CORE_Settings($args);
