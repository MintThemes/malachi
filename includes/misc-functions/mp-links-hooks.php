 ...
 */
function mt_malachi_mp_links_before_widget(){
	echo '<div class="social-holder">';
}
add_action( 'mp_links_before_widget', 'mt_malachi_mp_links_before_widget');

/**
 * Add styling before the mp-links widget
 */
function mt_malachi_mp_links_after_widget(){
	echo '</div>';
}
add_action( 'mp_links_after_widget', 'mt_malachi_mp_links_after_widget');

/**
 * Modify the types of links available as default for the mp_links plugin custom post type
 */
function mt_malachi_mp_links_array($mp_links_array){
